...
### Fixed
- Links de la sección **Documentación** del README convertidos a URLs absolutas a GitHub. Antes eran rutas relativas (`docs/quickstart.md`, etc.) que PyPI resolvía contra `https://pypi.org/project/contadb-sdk/` y devolvían 404.

[1.1.4]: https://github.com/aleksortiz/contadb-sdk/releases/tag/v1.1.4

## [1.1.3] - 2026-04-28

### Fixed
- `Documentation` en metadatos PyPI ahora apunta a `https://github.com/aleksortiz/contadb-sdk/tree/main/docs` (índice navegable de la carpeta `docs/`). Antes apuntaba a `#readme`, lo que hacía que los archivos `docs/*.md` no fueran visibles desde la página de PyPI.

[1.1.3]: https://github.com/aleksortiz/contadb-sdk/releases/tag/v1.1.3
